...
<body>
	...
	<div id="main">
		...
		<footer>
			<a href="https://github.com/MzTechnology97/PiscesQoLDashboard_log">Dashboard</a> Version: <?php echo $info['Version'];
			if($info['Version'] != $info['Update'])
			{
				echo ' - <a href="https://github.com/MzTechnology97/PiscesQoLDashboard_log" title="Update Releases">Update Available - '.$info['Update'].'</a>';
			}
			?>
